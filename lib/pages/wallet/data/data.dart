...
import 'package:flutter_ui_template/pages/wallet/models/credit_card_model.dart';
import 'package:flutter_ui_template/pages/wallet/models/payment_model.dart';
import 'package:flutter_ui_template/pages/wallet/models/user_model.dart';
...
List<UserModel> getUsersCard() {
  List<UserModel> userCards = [
    UserModel("Anna", Assets.walletUserAnna),
    UserModel("Gillian", Assets.walletUserGillian),
    UserModel("Judith", Assets.walletUserJudith),
  ];
